...
match the final run, the intermediate `even100` run, or `manuscript/Table-2-energetics.csv`
...
**Fix:** paste the ∆∆E_SA column from `manuscript/Table-2-energetics.csv`.
...
exist in `manuscript/abstract-jcim-unstructured.md`.
