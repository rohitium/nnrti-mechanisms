...
| **A2** Supp Table 3 | **regenerated.** G190E FEP rows are now −0.57 / −1.78 / −0.71 → **−1.02 ± 0.38**. All 18 genotypes reproduce Table 2 exactly. Written to `manuscript/` and `manuscript/post-feedback-from-atanu/`. |
...
| **A5 / A7** Supp Table 4 | **built.** New workbook, `manuscript/Supplementary-Table-4.xlsx` (+ submission copy). |
...
`manuscript/Supplementary-Table-4.xlsx`, three sheets:
...
### Housekeeping
`manuscript/Supplementary Table 4.xlsx` (with spaces, dated June) is an orphan from an abandoned
