...
from nnrti.fep.mutations import MANUSCRIPT_PLANS, MutationLeg, unique_manuscript_legs
from nnrti.fep.config import P0_LEGS
...
def _holo_genotype(label: str) -> str:
    from nnrti.fep.mutations import safe_label
...
def _replicate_row(leg: MutationLeg, replicate: int, phase: str) -> ReplicateAssets:
    ...
    if phase == "holo":
        ...
        from nnrti.fep.mutations import apo_safe_label
