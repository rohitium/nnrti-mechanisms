...
Usage
-----
    PYTHONPATH=. python -m nnrti.cli.plot_panel_by_resistance_category
"""
...
from ..analysis.panel import RESISTANT, SUSCEPTIBLE, UNCERTAIN
...
# combine_neq is now a module in this package, so the label repeller is a plain
# import rather than a load-from-path -- both figures place clustered genotype
# labels the same way, which is the point of sharing it.
from ..fep.combine_neq import _repel_labels
