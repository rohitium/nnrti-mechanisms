# Apply the all-contacted-region styling to the current PyMOL view.
# Usage: load 4NCG.cif or open your saved/manual 4NCG scene, set the camera,
# then run this script. It does not call orient, turn, zoom, or move.
