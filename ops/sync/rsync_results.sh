...
# Usage:
#   SHERLOCK_USER=rsatija bash ops/sync/rsync_results.sh
#   SHERLOCK_USER=rsatija bash ops/sync/rsync_results.sh push
#   SHERLOCK_USER=rsatija bash ops/sync/rsync_results.sh pull
# Optional:
#   DIRECTION=push|pull
