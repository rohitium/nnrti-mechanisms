...
#
# Usage:
#   bash ops/slurm/fep/prepare_p0_neq.sh
#   NEQ_SNAPSHOTS=100 REPLICATES=3 FORCE=1 bash ops/slurm/fep/prepare_p0_neq.sh  # refresh mdps/manifest; keeps outputs
#   REFRESH_MDPS_ONLY=1 bash ops/slurm/fep/prepare_p0_neq.sh                 # mdps only, no manifest rewrite
#
set -euo pipefail
