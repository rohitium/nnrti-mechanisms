...
#   ./ops/slurm/cluster/test_one_job.sh [mutation] [rep]
#
# Examples:
#   ./ops/slurm/cluster/test_one_job.sh              # auto-picks first incomplete system
#   ./ops/slurm/cluster/test_one_job.sh G190E 01     # test specific system
#
...
if [ $STATUS -eq 0 ]; then
    ...
    echo "Ready to submit batch jobs with: ./ops/slurm/cluster/submit_md_batched.sh 6 12"
else
    echo "=========================================="
