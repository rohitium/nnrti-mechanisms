...
| artifact | file |
|---|---|
| Table 2 | `paper/tables/Table-2-energetics.csv` |
| Supplementary Table 3 | `paper/submission/Supplementary-Table-3.xlsx` |
...
- `paper/abstract-jcim-unstructured.md` Option B quotes R² = 0.26/p = 0.07
