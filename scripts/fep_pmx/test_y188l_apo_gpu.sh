...
#   bash scripts/fep_pmx/salloc_apo_gpu.sh          # get gpu node
#   bash scripts/fep_pmx/test_y188l_apo_gpu.sh      # run inside allocation
#
# Optional:
#   REP=02 bash scripts/fep_pmx/test_y188l_apo_gpu.sh
#   MD_PRODUCTION_NS=0.05 bash scripts/fep_pmx/test_y188l_apo_gpu.sh
...
echo "  bash scripts/fep_pmx/submit_y188l_apo_md.sh"
echo ""
